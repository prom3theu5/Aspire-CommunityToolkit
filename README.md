...
| - **Learn More**: [`Hosting.Mise`][mise-integration-docs] <br /> - Stable 📦: [![CommunityToolkit.Aspire.Hosting.Mise][mise-shields]][mise-nuget] <br /> - Preview 📦: [![CommunityToolkit.Aspire.Hosting.Mise][mise-shields-preview]][mise-nuget-preview]                                                                                                                             | An Aspire hosting integration for [mise (mise-en-place)](https://mise.jdx.dev): installs the dev tools declared in mise.toml before resources start and injects mise-managed environments into resources. |
...
[mise-integration-docs]: https://learn.microsoft.com/dotnet/aspire/community-toolkit/hosting-mise
[mise-shields]: https://img.shields.io/nuget/v/CommunityToolkit.Aspire.Hosting.Mise
[mise-nuget]: https://nuget.org/packages/CommunityToolkit.Aspire.Hosting.Mise/
[mise-shields-preview]: https://img.shields.io/nuget/vpre/CommunityToolkit.Aspire.Hosting.Mise?label=nuget%20(preview)
[mise-nuget-preview]: https://nuget.org/packages/CommunityToolkit.Aspire.Hosting.Mise/absoluteLatest
